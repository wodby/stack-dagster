# Dagster stack for Wodby

Deploy Dagster on Kubernetes with Wodby. This repository contains the stack
manifests used by the public Dagster stack in the Wodby catalog.

- [Dagster stack in the Wodby catalog](https://wodby.com/stacks/dagster)
...
| --- | --- |
| Dagster<br>`dagster` | optional; enabled by default; links: `postgres` → `postgres` |
| PostgreSQL (`postgres`)<br>`postgres` | optional; enabled by default |
